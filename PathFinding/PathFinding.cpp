...
int main(void)
{
    ...
    std::vector<std::vector<SuperRectangle>> Cells; // 2D vector of rectangles
    ...
    while (!WindowShouldClose())
    {
        ...
        if (elapsed_secs > 0.02 && !found) {
            ...
            if (currentCell.state != 3) {
                ...
                if (x + 1 < 20 && !Cells[x + 1][y].visited && Cells[x + 1][y].state != 1) {
                ...
                if (y + 1 < 20 && !Cells[x][y + 1].visited && Cells[x][y + 1].state != 1) {
